...
public class TurnDisplay extends Actor{
	...
	public boolean scroll(){
		...
		addAction(Actions.sequence(Actions.moveTo((1280-sprite.getWidth())/2,getY(), (float) 2), Actions.delay(1f), Actions.moveTo(1280+sprite.getWidth(), getY(), 2), Actions.run(new Runnable() {
		    public void run () {
		        completed = true;
		    }
		}) ));
